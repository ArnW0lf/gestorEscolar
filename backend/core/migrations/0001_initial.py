# Generated by Django 5.2.1 on 2025-05-25 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('TEACHER', 'Docente'), ('STUDENT', 'Alumno')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades', models.ManyToManyField(related_name='subjects', to='core.grade')),
            ],
        ),
        migrations.CreateModel(
            name='GradeRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Presente'), ('A', 'Ausente'), ('J', 'Justificado')], max_length=1)),
